...
public class HrsApiSwaggerConfiguration implements WebMvcConfigurer {
	...
	public Docket api(List<ResponseMessage> responsesGobal, ApiInfo apiInfo) {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.paths(PathSelectors.regex("^(\\/v[0-9]{1,2}\\/.*)$"))
				.build()
					.apiInfo(apiInfo)
	...
	protected ApiInfo apiInfo() {
		...
		Contact contact = new Contact(	hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.contact.name"),
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.contact.url"),
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.contact.email"));

		return new ApiInfo(	hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.title"),
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.description"),
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.version"),
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.useTerms"),
										contact,
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.license"), 
										hrsApiPropertiesSupport.getProperty("hrs.microservice.region.docs.licenseUrl"),
